...
urlpatterns = [
    path('api/documents/', DocumentListCreateAPIView, name='parent-list-create'),
    path('api/add/image', ChildCreateAPIView.as_view(), name='parent-list-create'),
    path('api/add/document', DocumentCreateAPIView.as_view(), name='parent-list-create'),
